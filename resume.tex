...
\section{教育背景}
\cventry{2008--2012}{本科}{江苏科技大学}{镇江}{\textit{计算机科学与技术}}{主要专业课程有数字电子技术基础、数据结构、C++、计算机组成原理、微机原理与接口技术、数据库等}  % 第3到第6编码可留白
...
\section{工作背景}
\cventry{2012 -- 至今}{软件工程师}{南京}{吉隆光纤通信股份有限公司}{}{公司主要业务为光纤通信仪器仪表的研发生产销售。%\newline{}%
工作内容:%
\begin{itemize}%
\item 参与公司主打产品（光纤熔接机）新平台软件的开发，负责部分驱动程序及应用程序开发工作;
\item 熟悉openembeded，使用其构建嵌入式linux开发环境;
\item 维护软件小团队的服务器，熟练使用git，搭建gitweb，gitlab等等代码管理工具。
\end{itemize}}

\section{项目经验}
\cventry{2012.9--2014.4}{光纤熔接机新一代控制软件开发}{linux}{arm+fpga}{c/c++}{
\begin{itemize}%
	\item 项目描述：
		\begin{itemize}
...
\section{语言技能}
\cvitemwithcomment{英语}{四级}{熟练}

\section{计算机技能}
\cventry{2012.7}{嵌入式linux工程师}{工信部软件和集成电路促进中心}{}{}{}
...
\section{个人兴趣}
\cvitem{篮球}{\small 平时爱好运动，锻炼身体同时磨练意志。}
